...
export default class Function {
  ...
  public constructor(inputFilePath: string, outputPath: string, clientId: string, keyFilePath: string, jsonOutput: boolean, sfDomain: string) {
    ...
    this.MapSelector = new Map<string,string>(
        ...
        ['cgcloud__Tactic_Template__c','standard'],
        ['CGT_Planning_Level__c','standard'],
        ['CGT_PromoSnapshotDates__c','standard'],
        ['cgcloud__BO_API_Transaction_Log__c','standard'],
        ['CGT_AccSpecificProductCondition__c','standard'],
        ['CGT_Account_IO_Customer_Mapping__c','standard'],
        ['CGT_OverlappingFieldConfiguration__c','standard'],
        ['cgcloud__Account_Specific_Product_Condition__c','standard'],
        ['SWOP_RateCard__c','standard'],
        ['CGK_RIF_PCF__c','standard'],
        ['cgcloud__Account_Set__c','standard'],
        ['cgcloud__Data_Type__c','standard'],
        ['cgcloud__Job_Definition_List__c','standard'],
        ['cgcloud__Job_Definition_Template__c','standard'],
        ['cgcloud__Order__c','standard'],
        ['cgcloud__Org_Unit__c','standard'],
        ['cgcloud__Sales_Folder__c','standard'],
        ['cgcloud__Visit_Template__c','standard'],
        ['cgcloud__Field_Sales_Activity__c','standard'],
        ['cgcloud__Promotion_Store__c','standard'],
        ['cgcloud__Job_List__c','standard'],
        ['cgcloud__Sell_Sheet__c','standard'],
        ['cgcloud__Segmentation_Rule__c','standard'],
        ['cgcloud__BO_API_Workflow_Step__c','standard'],
        ['cgcloud__BO_API_Workflow__c','standard'],
        ['cgcloud__BO_API__c','standard'],
        ['cgcloud__Custom_Permission_User_Role_Mapping__c','standard'],
        ['cgcloud__Fund_Transaction__c','standard'],
        ['cgcloud__KPI_Set__c','standard'],
        ['cgcloud__Product_Hierarchy__c','standard'],
        ['cgcloud__Tactic_Fund__c','standard'],
        ['cgcloud__Workflow__c','standard'],
        ['CGT_Condition_Codes__c','standard'],
        ['CGT_TacticFieldDependenciesValidation__c','standard'],
        ['CGT_TacticFieldDependencyRelationship__c','standard'],
        ['CGT_Workflow_Threshold__c','standard'],
			]);
